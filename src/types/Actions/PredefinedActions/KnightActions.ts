...
//Low Cost
export const basicAttack = () => createAction("Basic Slash", [createAttack("Basic Slash", 1)], 1)
export const basicBlock = () => createAction("Basic Block", [createShield("Basic Block", 5)], 2);

export const quickSlash = () => createAction("Quick Slash", [createAttack("Quick Slash", 3)], 1);
